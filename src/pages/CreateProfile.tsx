  ...
  const profileOptions = [
    {
      ...
      title: 'Student',
      description: 'Student interested in child welfare research and practice',
      icon: GraduationCap,
    ...
    },
    {
      ...
      title: 'Researcher',
      description: 'Academic or industry researcher in child welfare and social services',
      icon: Microscope,
    ...
    },
    {
      ...
      title: 'Agency',
      description: 'Government or non-profit child welfare and social services agency',
      icon: Building2,
